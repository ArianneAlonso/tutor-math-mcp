      ...
      {isOpen && (
        <div className="fixed top-0 left-0 h-full w-64 bg-white border-r border-slate-200 flex flex-col z-50">
          ...
          <div className="flex items-center justify-between p-4 border-b border-slate-200">
            <span className="text-slate-700 font-semibold">Menú</span>
          ...
          <nav className="px-2 space-y-1">
            ...
            <button
              ...
              className={`flex items-center gap-2 w-full px-3 py-2 rounded-lg text-sm transition ${
                showPizarra ? "bg-slate-200 text-slate-900" : "hover:bg-slate-100 text-slate-700"
              }`}
            >
            ...
            <div className="mt-4">
              ...
              <div className="space-y-1">
                {conversations.length === 0 && (
                  <p className="px-3 py-2 text-sm text-slate-400">No hay chats</p>
                )}
